...
<!-- ********* -->
	...
	<!-- Tems -->
	<link rel="stylesheet" class="black_link" type="text/css" media="screen" href="${rootPath}/resource/css/black/custom_tems.css">	
...
<!-- *************** -->
	...
	<script src="${rootPath}/resource/ext/pdfjs/pdfobject.min.js"></script>
	
	<script src="${rootPath}/resource/ext/d3/d3.v4.4.4.js"></script>
